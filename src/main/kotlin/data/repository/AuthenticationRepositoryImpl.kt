...
class AuthenticationRepositoryImpl(
    ...
    override suspend fun login(
        username: String,
        hashedPassword: String,
    ): User = remoteAuthenticationDataSource.login(username, hashedPassword)

    override suspend fun logout() {
        remoteAuthenticationDataSource.logout()
    }

    override suspend fun getAllUsers(): List<User> = remoteAuthenticationDataSource.getAllUsers()
}
